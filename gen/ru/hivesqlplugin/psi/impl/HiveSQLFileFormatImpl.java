...
public class HiveSQLFileFormatImpl extends ASTWrapperPsiElement implements HiveSQLFileFormat {

  public HiveSQLFileFormatImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HiveSQLVisitor visitor) {
    visitor.visitFileFormat(this);
  }
