...
public class HiveSQLMapTypeImpl extends ASTWrapperPsiElement implements HiveSQLMapType {

  public HiveSQLMapTypeImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public HiveSQLDataType getDataType() {
    return findNotNullChildByClass(HiveSQLDataType.class);
  }

  @Override
  @NotNull
  public HiveSQLPrimitiveType getPrimitiveType() {
    return findNotNullChildByClass(HiveSQLPrimitiveType.class);
  }
